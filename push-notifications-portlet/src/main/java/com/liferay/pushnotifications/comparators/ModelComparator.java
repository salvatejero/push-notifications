 ...
 *
 */
public class ModelComparator extends OrderByComparator {
	...
	public static String ORDER_BY_DESC = "model DESC";

	public static String ORDER_BY_ASC = "model ASC";
	...
	public int compare(Object arg0, Object arg1) {
		...
		int result = dev1.getModel().compareToIgnoreCase(dev2.getModel());
